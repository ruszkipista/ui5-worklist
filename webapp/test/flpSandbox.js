		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#opensapmanageproduct-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"opensapmanageproduct-display": {
								"semanticObject": "opensapmanageproduct",
								"action": "display",
								"description": "Worklist - Manage Products",
								"title": "Manage Products",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=opensap.manageproduct",
									"url": sap.ui.require.toUrl("opensap/manageproduct")
								}
							}
						}
					}
